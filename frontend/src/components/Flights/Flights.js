							...
							<Modal isOpen={this.state.openModal} toggle={this.toggleModal}>
								...
								<ModalFooter>
									<div>
										<div>
											Pic1
											<input className="new-flight-pic-input" name="pic" onChange={this.handleInputChange} />
										</div>
										<div>
											Cross Country
											<input className="new-flight-pic-input" name="cross_country" onChange={this.handleInputChange} />
										</div>
										<div>
											No Instr app.
											<input
										...
										<div>
											No. Ldg.
											<input className="new-flight-pic-input" name="no_ldg" onChange={this.handleInputChange} />
										</div>
										<div>
											Day
											<input className="new-flight-pic-input" name="day" onChange={this.handleInputChange} />
										</div>
										<div>
											Night
											<input className="new-flight-pic-input" name="night" onChange={this.handleInputChange} />
										</div>
										<div>
											Actual Instr.
											<input className="new-flight-pic-input" name="actual_instr" onChange={this.handleInputChange} />
										</div>
										<div>
											Sim. Instr.
											<input className="new-flight-pic-input" name="sim_instr" onChange={this.handleInputChange} />
										</div>
										<div>
											Dual Rec.
											<input className="new-flight-pic-input" name="dual_rec" onChange={this.handleInputChange} />
										</div>
										<div>
											Total
											<input className="new-flight-pic-input" name="total_hours" onChange={this.handleInputChange} />
