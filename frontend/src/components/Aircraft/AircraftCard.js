...
const dev = true;
let URL = dev ? 'http://127.0.0.1:8000/api' : 'https://flightloggercs10.herokuapp.com/api';
...
class AircraftCardModal extends React.Component {
	...
	render() {
		...
		let [ pic_sum, no_ldg, day, night, cross_country, actual_instr, sim_instr, dual_rec ] = [ 0, 0, 0, 0, 0, 0, 0 ];
				...
				<Modal className="modal-content" isOpen={this.state.modal} toggle={this.toggle}>
					...
					<ModalBody className="modal-body">
						...
						>
							...
							<ModalBody className="nested-modal-body">Drag and Drop Image</ModalBody>
							<ModalFooter>
								{/* CLOSE NESTED */}
