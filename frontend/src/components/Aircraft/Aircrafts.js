	...
	render() {
		return (
          ...
          <CardContent>
              ...
              <ModalHeader>
                <input className="new-aircraft-input-tn" name="tail_number_edit" onChange={this.handleChange} placeholder="Tail Number" />
                <input className="new-aircraft-input-lt" name="license_type_edit" onChange={this.handleChange} placeholder="License Type" />
                <input className="new-aircraft-input-mt" name="man_type_edit" onChange={this.handleChange} placeholder="Manufacturer Type" />
              </ModalHeader>
